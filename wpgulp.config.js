...
module.exports = {
	...
	// Project options.
	projectURL: 'stb', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'stb', // Your textdomain here.
	translationFile: 'STB.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'stb', // Package name.
	bugReport: 'https://haskellisp.com/contact', // Where can users report bugs.
	lastTranslator: 'hask <haskellisp@gmail.com>', // Last translator Email ID.
	team: '<haskellisp@gmail.com>', // Team's Email ID.
